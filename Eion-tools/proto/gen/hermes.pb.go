...
const file_hermes_proto_rawDesc = "" +
	...
	"\ttool_list\x18\x03 \x01(\v2\x17.hermes.ToolListRequestH\x00R\btoolListB\t\n" +
	"\apayload\"\xf6\x01\n" +
	"\rAgentResponse\x127\n" +
	...
	"\ttool_list\x18\x04 \x01(\v2\x18.hermes.ToolListResponseH\x00R\btoolListB\t\n" +
...
var file_hermes_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_hermes_proto_goTypes = []any{
	...
	(*ToolListRequest)(nil),  // 8: hermes.ToolListRequest
	(*ToolListResponse)(nil), // 9: hermes.ToolListResponse
	(*AgentRequest)(nil),     // 10: hermes.AgentRequest
	(*AgentResponse)(nil),    // 11: hermes.AgentResponse
}
var file_hermes_proto_depIdxs = []int32{
	...
	3,  // 5: hermes.AgentRequest.llm_infer:type_name -> hermes.LLMInferRequest
	6,  // 6: hermes.AgentRequest.tool_exec:type_name -> hermes.ToolExecRequest
	8,  // 7: hermes.AgentRequest.tool_list:type_name -> hermes.ToolListRequest
	4,  // 8: hermes.AgentResponse.llm_infer:type_name -> hermes.LLMInferResponse
	7,  // 9: hermes.AgentResponse.tool_exec:type_name -> hermes.ToolExecResponse
	5,  // 10: hermes.AgentResponse.llm_chunk:type_name -> hermes.LlmChunk
	9,  // 11: hermes.AgentResponse.tool_list:type_name -> hermes.ToolListResponse
...
func file_hermes_proto_init() {
	...
	file_hermes_proto_msgTypes[10].OneofWrappers = []any{
		(*AgentRequest_LlmInfer)(nil),
		(*AgentRequest_ToolExec)(nil),
		(*AgentRequest_ToolList)(nil),
	}
	file_hermes_proto_msgTypes[11].OneofWrappers = []any{
