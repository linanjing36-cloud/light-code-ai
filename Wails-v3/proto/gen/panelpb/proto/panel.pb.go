...
type PanelRequest struct {
	...
	Method        string                 `protobuf:"bytes,2,opt,name=method,proto3" json:"method,omitempty"`                        // start_session / send / list_tools / approve / brain_status / stop
...
var file_proto_panel_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_proto_panel_proto_goTypes = []any{
	...
	(*StartSessionResult)(nil), // 12: panel.StartSessionResult
	(*SendResult)(nil),         // 13: panel.SendResult
	(*ListToolsResult)(nil),    // 14: panel.ListToolsResult
	(*ToolDesc)(nil),           // 15: panel.ToolDesc
	(*ApproveResult)(nil),      // 16: panel.ApproveResult
	(*BrainStatusResult)(nil),  // 17: panel.BrainStatusResult
	(*StopResult)(nil),         // 18: panel.StopResult
}
var file_proto_panel_proto_depIdxs = []int32{
	...
	15, // 7: panel.ListToolsResult.tools:type_name -> panel.ToolDesc
